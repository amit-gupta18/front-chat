...
const ChatPage = () => {
    ...
    return (
        <div className='h-screen flex flex-col'>
            <header className='flex items-center justify-around bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white p-4'>
                {/* Room name container */}
                <div>
                ...
                {/* Leave Now Button container */}
                <div>
                    <button className='bg-red-500 text-white rounded-full px-4 py-2 cursor-pointer mt-4'>Leave Now</button>
                </div>
            </header>

            {/* Chat Messages Container */}
            <div
                className='flex-1 w-2/3 flex flex-col justify-end dark:bg-slate-600 mx-auto overflow '
            >
            ...
            <div className='fixed bottom-0 left-0 right-0 bg-gray-100 dark:bg-gray-900 p-4 flex items-center justify-between'>
